...
public class AuctionPromptScreen extends Screen {
    ...
    public AuctionPromptScreen(boolean requireAPIKey, boolean requireUsername){
    ...
    public void initGuis(){
        ...
        ButtonWidget closeButton = ButtonWidget.builder(Text.of("Close"), button -> client.setScreen(null))
            .dimensions(closeButtonX, button_y, BUTTON_WIDTH, ELEMENT_HEIGHT)
            .build();
        ...
        }).dimensions(submitButtonX, button_y, BUTTON_WIDTH, ELEMENT_HEIGHT).build();
